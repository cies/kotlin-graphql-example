...
class ArchitectureTest {
  ...
  fun `the project's packages have correct dependencies on each other`() {
    ...
    Konsist.scopeFromDirectory("src").assertArchitecture {
      ...
      libMonolith.doesNotDependOn(handler, routing, workflow, presentation, libFulfillment, shopify)
      ...
      libJson.doesNotDependOn(handler, routing, workflow, presentation, libFulfillment, libMonolith, shopify, config)
      libKtor.doesNotDependOn(handler, routing, workflow, presentation, libFulfillment, libMonolith, shopify, config)
      shopify.doesNotDependOn(handler, routing, workflow, presentation, libMonolith)
