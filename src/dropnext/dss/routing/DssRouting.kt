...
import dropnext.dss.lib.ktor.plugin.requireDssInternalSecret
 ...
 *
 * Every route mounted here sits inside [requireDssInternalSecret], so handlers never have to
