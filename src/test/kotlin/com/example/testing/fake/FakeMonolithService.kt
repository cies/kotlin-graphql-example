package com.example.testing.fake

import com.example.lib.dss.dto.CreateOrderResponse
  ...
  private fun Application.fakeMonolithModule() {
    ...
    routing {
      post(ordersPath) {
        ...
        val orderId =
          runCatching { json.decodeFromString(CreateShopifyOrderRequest.serializer(), text).shopifyOrderId }
            .getOrNull()
            ?: 0L
