...
import { createInvoiceNote, deleteInvoiceNote } from "@/lib/actions/invoices";
...
export function InvoiceNotesPanel({ orgSlug, invoiceId, notes }: Props) {
  ...
  async function handleAdd() {
    ...
    setSaving(true);
    const res = await createInvoiceNote(orgSlug, invoiceId, content.trim());
    setSaving(false);
  ...
  async function handleDelete(noteId: string) {
    ...
    await deleteInvoiceNote(orgSlug, invoiceId, noteId);
    setDeletingId(null);
    router.refresh();
  }
